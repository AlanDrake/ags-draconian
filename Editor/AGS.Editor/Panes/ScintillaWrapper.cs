...
namespace AGS.Editor
{
    ...
    public partial class ScintillaWrapper : UserControl, IScriptEditorControl
    {
        ...
        private void LoadColorTheme(ColorTheme t)
        {
            ...
            t.SetColor("script-editor/text-editor/global-default/background", c => scintillaControl1.StyleSetBack(Cpp.GlobalDefault, c));
            t.SetColor("script-editor/text-editor/global-default/foreground", c => scintillaControl1.StyleSetFore(Cpp.GlobalDefault, c));
            t.SetColor("script-editor/text-editor/default/background", c => scintillaControl1.StyleSetBack(Cpp.Default, c));
            t.SetColor("script-editor/text-editor/default/foreground", c => scintillaControl1.StyleSetFore(Cpp.Default, c));
            t.SetColor("script-editor/text-editor/word-1/background", c => scintillaControl1.StyleSetBack(Cpp.Word, c));
            t.SetColor("script-editor/text-editor/word-1/foreground", c => scintillaControl1.StyleSetFore(Cpp.Word, c));
            t.SetColor("script-editor/text-editor/word-2/background", c => scintillaControl1.StyleSetBack(Cpp.Word2, c));
            t.SetColor("script-editor/text-editor/word-2/foreground", c => scintillaControl1.StyleSetFore(Cpp.Word2, c));
            t.SetColor("script-editor/text-editor/identifier/background", c => scintillaControl1.StyleSetBack(Cpp.Identifier, c));
            t.SetColor("script-editor/text-editor/identifier/foreground", c => scintillaControl1.StyleSetFore(Cpp.Identifier, c));
            t.SetColor("script-editor/text-editor/comment/background", c => scintillaControl1.StyleSetBack(Cpp.Comment, c));
            t.SetColor("script-editor/text-editor/comment/foreground", c => scintillaControl1.StyleSetFore(Cpp.Comment, c));
            t.SetColor("script-editor/text-editor/comment-line/background", c => scintillaControl1.StyleSetBack(Cpp.CommentLine, c));
            t.SetColor("script-editor/text-editor/comment-line/foreground", c => scintillaControl1.StyleSetFore(Cpp.CommentLine, c));
            t.SetColor("script-editor/text-editor/comment-doc/background", c => scintillaControl1.StyleSetBack(Cpp.CommentDoc, c));
            t.SetColor("script-editor/text-editor/comment-doc/foreground", c => scintillaControl1.StyleSetFore(Cpp.CommentDoc, c));
            t.SetColor("script-editor/text-editor/comment-line-doc/background", c => scintillaControl1.StyleSetBack(Cpp.CommentLineDoc, c));
            t.SetColor("script-editor/text-editor/comment-line-doc/foreground", c => scintillaControl1.StyleSetFore(Cpp.CommentLineDoc, c));
            t.SetColor("script-editor/text-editor/comment-doc-keyword/background", c => scintillaControl1.StyleSetBack(Cpp.CommentDocKeyword, c));
            t.SetColor("script-editor/text-editor/comment-doc-keyword/foreground", c => scintillaControl1.StyleSetFore(Cpp.CommentDocKeyword, c));
            t.SetColor("script-editor/text-editor/comment-doc-keyword-error/background", c => scintillaControl1.StyleSetBack(Cpp.CommentDocKeywordError, c));
            t.SetColor("script-editor/text-editor/comment-doc-keyword-error/foreground", c => scintillaControl1.StyleSetFore(Cpp.CommentDocKeywordError, c));
            t.SetColor("script-editor/text-editor/number/background", c => scintillaControl1.StyleSetBack(Cpp.Number, c));
            t.SetColor("script-editor/text-editor/number/foreground", c => scintillaControl1.StyleSetFore(Cpp.Number, c));
            t.SetColor("script-editor/text-editor/regex/background", c => scintillaControl1.StyleSetBack(Cpp.Regex, c));
            t.SetColor("script-editor/text-editor/regex/foreground", c => scintillaControl1.StyleSetFore(Cpp.Regex, c));
            t.SetColor("script-editor/text-editor/string/background", c => scintillaControl1.StyleSetBack(Cpp.String, c));
            t.SetColor("script-editor/text-editor/string/foreground", c => scintillaControl1.StyleSetFore(Cpp.String, c));
            t.SetColor("script-editor/text-editor/string-eol/background", c => scintillaControl1.StyleSetBack(Cpp.StringEol, c));
            t.SetColor("script-editor/text-editor/string-eol/foreground", c => scintillaControl1.StyleSetFore(Cpp.StringEol, c));
            t.SetColor("script-editor/text-editor/operator/background", c => scintillaControl1.StyleSetBack(Cpp.Operator, c));
            t.SetColor("script-editor/text-editor/operator/foreground", c => scintillaControl1.StyleSetFore(Cpp.Operator, c));
            t.SetColor("script-editor/text-editor/preprocessor/background", c => scintillaControl1.StyleSetBack(Cpp.Preprocessor, c));
            t.SetColor("script-editor/text-editor/preprocessor/foreground", c => scintillaControl1.StyleSetFore(Cpp.Preprocessor, c));
            t.SetColor("script-editor/text-editor/line-number/background", c => scintillaControl1.StyleSetBack(Cpp.LineNumber, c));
            t.SetColor("script-editor/text-editor/line-number/foreground", c => scintillaControl1.StyleSetFore(Cpp.LineNumber, c));
            t.SetColor("script-editor/text-editor/indent-guide/background", c => scintillaControl1.StyleSetBack(Cpp.IndentGuide, c));
            t.SetColor("script-editor/text-editor/indent-guide/foreground", c => scintillaControl1.StyleSetFore(Cpp.IndentGuide, c));

            t.SetColor("script-editor/text-editor/fold-margin", c => scintillaControl1.SetFoldMarginColor(true, Scintilla.Utilities.ColorToRgb(c)));
            t.SetColor("script-editor/text-editor/fold-margin-hi", c => scintillaControl1.SetFoldMarginHiColor(true, Scintilla.Utilities.ColorToRgb(c)));
            t.SetColor("script-editor/text-editor/marknum-folder/background", c => scintillaControl1.MarkerSetBack(Scintilla.Constants.SC_MARKNUM_FOLDER, c));
            t.SetColor("script-editor/text-editor/marknum-folder/foreground", c => scintillaControl1.MarkerSetFore(Scintilla.Constants.SC_MARKNUM_FOLDER, c));
            t.SetColor("script-editor/text-editor/marknum-folder-end/background", c => scintillaControl1.MarkerSetBack(Scintilla.Constants.SC_MARKNUM_FOLDEREND, c));
            t.SetColor("script-editor/text-editor/marknum-folder-end/foreground", c => scintillaControl1.MarkerSetFore(Scintilla.Constants.SC_MARKNUM_FOLDEREND, c));
            t.SetColor("script-editor/text-editor/marknum-folder-open/background", c => scintillaControl1.MarkerSetBack(Scintilla.Constants.SC_MARKNUM_FOLDEROPEN, c));
            t.SetColor("script-editor/text-editor/marknum-folder-open/foreground", c => scintillaControl1.MarkerSetFore(Scintilla.Constants.SC_MARKNUM_FOLDEROPEN, c));
            t.SetColor("script-editor/text-editor/marknum-folder-open-mid/background", c => scintillaControl1.MarkerSetBack(Scintilla.Constants.SC_MARKNUM_FOLDEROPENMID, c));
            t.SetColor("script-editor/text-editor/marknum-folder-open-mid/foreground", c => scintillaControl1.MarkerSetFore(Scintilla.Constants.SC_MARKNUM_FOLDEROPENMID, c));
            t.SetColor("script-editor/text-editor/marknum-folder-mid-tail", c => scintillaControl1.MarkerSetBack(Scintilla.Constants.SC_MARKNUM_FOLDERMIDTAIL, c));
            t.SetColor("script-editor/text-editor/marknum-folder-sub", c => scintillaControl1.MarkerSetBack(Scintilla.Constants.SC_MARKNUM_FOLDERSUB, c));
            t.SetColor("script-editor/text-editor/marknum-folder-tail", c => scintillaControl1.MarkerSetBack(Scintilla.Constants.SC_MARKNUM_FOLDERTAIL, c));
            t.SetColor("script-editor/text-editor/selected/background", c => scintillaControl1.SetSelBack(c != Color.Transparent, c));
            t.SetColor("script-editor/text-editor/selected/foreground", c => scintillaControl1.SetSelFore(c != Color.Transparent, c));


            t.SetColor("script-editor/text-editor/marker-breakpoint/background", c => scintillaControl1.MarkerSetBack(MARKER_TYPE_BREAKPOINT, c));
            t.SetColor("script-editor/text-editor/marker-breakpoint/foreground", c => scintillaControl1.MarkerSetFore(MARKER_TYPE_BREAKPOINT, c));
            t.SetColor("script-editor/text-editor/marker-breakpoint2/background", c => scintillaControl1.MarkerSetBack(MARKER_TYPE_BREAKPOINT2, c));
            t.SetColor("script-editor/text-editor/marker-breakpoint2/foreground", c => scintillaControl1.MarkerSetFore(MARKER_TYPE_BREAKPOINT2, c));
            t.SetColor("script-editor/text-editor/current-statement/background", c => scintillaControl1.MarkerSetBack(MARKER_TYPE_CURRENT_STATEMENT, c));
            t.SetColor("script-editor/text-editor/current-statement/foreground", c => scintillaControl1.MarkerSetFore(MARKER_TYPE_CURRENT_STATEMENT, c));
            t.SetColor("script-editor/text-editor/current-statement2/background", c => scintillaControl1.MarkerSetBack(MARKER_TYPE_CURRENT_STATEMENT2, c));
            t.SetColor("script-editor/text-editor/current-statement2/foreground", c => scintillaControl1.MarkerSetFore(MARKER_TYPE_CURRENT_STATEMENT2, c));

            t.SetColor("script-editor/text-editor/caret/caret-fore", c => scintillaControl1.CaretFore = Scintilla.Utilities.ColorToRgb(c));
            t.SetColor("script-editor/text-editor/caret/caret-line-back", c => scintillaControl1.CaretLineBack = Scintilla.Utilities.ColorToRgb(c));
            t.SetInt("script-editor/text-editor/caret/caret-line-back-alpha", i => scintillaControl1.CaretLineBackAlpha = i);
