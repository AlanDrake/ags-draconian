...
namespace AGS.Editor
{
    public partial class RoomSettingsEditor : EditorContentPanel
    {
        ...
        private void LoadColorTheme(ColorTheme t)
        {
            ...
            t.SetColor("room-editor/box/background", c => mainFrame.BackColor = c);
            t.SetColor("room-editor/box/foreground", c => mainFrame.ForeColor = c);
            ...
            /*if (t.Has("room-editor/combo-backgrounds"))
            {
