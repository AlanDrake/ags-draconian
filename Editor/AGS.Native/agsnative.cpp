  ...
  if ((colDepth != thisgame.color_depth * 8) && (fixColourDepth))
  {
    ...
    if (transparency_index != 0)
    {
      ...
      else
      {
        ...
        if ((needToFixColourDepth && thisgame.color_depth == 2) && (i > 0) &&
            ...
            (imgpal[i].b == imgpal[0].b))
        {
          ...
          // any transparency
          imgpal[i].r = (imgpal[0].r < 128) ? (imgpal[0].r + 1) : (imgpal[0].r - 1);
			    imgpal[i].g = (imgpal[0].g < 128) ? (imgpal[0].g + 1) : (imgpal[0].g - 1);
			    imgpal[i].b = (imgpal[0].b < 128) ? (imgpal[0].b + 1) : (imgpal[0].b - 1);
        }
      }
		}
	}
      ...
      for (int ww = 0; ww<tempsprite->GetWidth(); ww++) {
        for (int vv = 0; vv<tempsprite->GetHeight(); vv++) {
          ...
          if (keepTransparency && px == 0)
            ...
            spriteAtRightDepth->PutPixel(ww, vv, makecol_depth(thisgame.color_depth * 8, pal_color.r, pal_color.g, pal_color.b-1));
          else
